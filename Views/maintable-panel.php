...
if (isset($_POST['searchButton'])) {
    $films = $read->searchMain(htmlspecialchars($_POST['searchInput']));
...
<div class="card mt-4 shadow  mb-2 bg-body rounded">
    ...
    <div class="card-body">
            ...
            <div class="hstack gap-2 mb-3">
                ...
                <div class="col-3 ms-auto">
                    <form action="" method="POST" class="input-group input-group-sm">
                        <input type="text" class="form-control form-control-sm text-secondary" name="searchInput" placeholder="search..." aria-label="search..." value="<?php if (isset($_POST['searchInput'])) $value = $_POST['searchInput'];
        ...
        <?php if (isset($_POST['searchButton']) && $_POST['searchInput'] != "") { ?>
            <p class="text-secondary " style="font-weight:700; font-family: 'Nunito', sans-serif; font-size: 13px;">Founded data : <?php echo count($films) ?> </p>
