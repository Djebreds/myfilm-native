    ...
    <div class="card mt-4 shadow  mb-2 bg-body rounded">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-3">
                    <div class="input-group input-group-sm mb-3 text-end">
                        <input type="text" class="form-control" placeholder="Recipient's username" aria-label="Recipient's username" aria-describedby="button-addon2">
                        <button class="btn btn-primary" type="submit" id="button-addon2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                        ...
                        <td>
                            ...
                            <div class="btn-group btn-group-sm">
                                <div class="btn-group btn-group-sm dropup">
                                    <button type="button" class="btn btn-primary btn-sm" id="dropdownMenuClickableOutside" data-bs-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 18 18">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end drop-menu">
                                        <li>
                                            <p class="dropdown-header drop">Edit</p>
                                        </li>
                                    </ul>
                                </div>
                                <div class="btn-group btn-group-sm">
                                    <button type="button" class="btn btn-primary dropdown-toggle btn-sm" id="dropdownMenuClickableOutside" data-bs-toggle="dropdown" data-bs-auto-close="inside" aria-expanded="false">
                                        ...
                                        <li>
                                            <div class="row align-items-center">
                                                <div class="col-6 text-center">
                                                    <a href="#" class="dropdown-item text-center text-danger">Yes</a>
                                                </div>
                                                <div class="col-6">
                                                    <a href="#" class="dropdown-item text-center text-primary">No</a>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                            ...
                            <div class="btn-group btn-group-sm">
                                ...
                                <div class="btn-group btn-group-sm">
                                    <button type="button" class="btn btn-danger dropdown-toggle btn-sm" id="dropdownMenuClickableOutside" data-bs-toggle="dropdown" data-bs-auto-close="inside" aria-expanded="false">
                                        <span class="visually-hidden">Toggle Dropdown</span>
                                    </button>
                                    <ul class="dropdown-menu dropdown-menu-end drop-menu" aria-labelledby="dropdownMenuClickableOutside">
                                        <li>
